...
class Shape10 implements Shape {
    ...
    rotate() {
        if (this.shape1.left < this.shape2.left && this.shape2.top < this.shape3.top) {
            this.shape3.top -= 80;
            this.top -= 40;
        }
        else if (this.shape1.left < this.shape2.left && this.shape2.top > this.shape3.top) {
            this.shape1.left += 80;
        }
        else if (this.shape1.left > this.shape2.left && this.shape2.top > this.shape3.top) {
            this.shape3.top += 80;
        ...
        if (this.shape1.left > 360) {
            this.shape2.left = 320;
            this.shape1.left = 360;
    ...
    isShapeOutOfBoundsLeft() {
        return this.shape1.left == 0 || this.shape2.left == 0;
    }
    isShapeOutOfBoundsRight() {
        return this.shape1.left == 360 || this.shape2.left == 360;
    }
